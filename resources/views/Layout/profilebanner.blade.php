 ...
 <div class="row h m-0">
     <div class="col-lg-8 col-sm-12 p-0">
         @if($user->image == null)
         <img style="height:80; width:80%;" src="/images/noImage.png" alt="Post Image">
         @else
         ...
         <div class="post-h">
                         ...
                         <div class="modal-content">
                             ...
                             <div class="modal-body">
                                 <div class="row">
                                     <div class="col-sm-4">
                                         @if($user->avatar == null)
                                         <img class="img-fluid" src="/images/noImage.png" alt="AvatarUser">
                                         @else
                                     ...
                                     <div class="col-sm-8 profile-modal">
                                         ...
                                         <form method="POST" action="{{ route('updateUser') }}" class="update_user">
                                             ...
                                             <textarea name="biography" id="u_bio" rows="6"
                                                 cols="35">{{$user->biography}}</textarea>
             ...
             <div class="row">
                 ...
                 <div class="col-sm-8 ">
                     ...
                     <div class="row col-sm-12">
                         <h5 class="text-break">&nbsp Written Posts
                             Posts:<?php $id= auth()->id(); $users = DB::table('posts')->where('user_id',$id)->count();?>
                            # {{ $users }}
                         </h5>
                     </div>
                 </div>
     ...
     <div class="col-lg-4 col-sm-12 p-0">
         ...
         <div class="row">
             <div class="col-sm-12">
                 ...
                 <img style="height:100%; width:100%;" src="/images/noImage.png" alt="Post Image">
                 @else
                 ...
                 <div class="post-h">
                     ...
                     <div class="row col-sm-10">
                         <h1 class="text-break text-capitalize">{{ $post->title }}</h1>
                     </div>
                     <div class="row">
                         <div class="col-sm-10 d-flex">
                             <h5 class="text-break text-capitalize"><a href="#">#</a>{{ $post->content }} </h5>
                             <p>@ {{$post->created_at}}</p>
                         </div>
                     ...
                     <div class="modal-content">
                         ...
                         <div class="modal-body">
                             <div class="row">
                                 ...
                                 <div class="col-sm-8 profile-modal">
                                     <div class="row col-sm-12">
                                         <h2 class="text-capitalize"><span class="clr-blue">#</span>{{$user->name}}</h2>
                                     </div>
                                     <div class="row col-sm-12">
                                     ...
                                     <div class="row col-sm-12">
                                         <p><span class="green-underline">Biography:</span><br>{{$user->biography}}
                                         </p>
                                     </div>
                                     <div class="row col-sm-12">
