            ...
            <div class="col-sm-7 shadow ">
                <div class="post shadow row p-2">
                    ...
                    <div class="col-sm-8" style="border-bottom: 1px solid #0275d8;">
                        <h2 style="text-transform:capitalize;color:#0275d8">#<a id="post-links" href="/posts/{{$post->id}}">{{ $post->title }}</a>
                        </h2>
                        <p>{{ $post->content}}<p>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <p class="p-0 m-0">Posted By<h4 style="color:#0275d8">@<a id="post-links" href="#">{{ $post->author->name ?? "N/A"}}</a></h4></p>
                                    </div>
                                    <div class="col-sm-6"><i style="color:#0275d8;" class="far fa-calendar-alt"></i> {{ $post->created_at}}</div>
            ...
            <div class="col-sm-5 shadow" style="background-color: #fff;">
                ...
                <div class="row m-1" style="border-left: 1px solid black">
                    ...
                    <div class="col-sm-4 author-img">
                        <img class="img-fluid rounded-circle" style="border: 2px solid #0275d8; height:80px; width:100px;"
