                ...
                <div class="card-body">
                    ...
                    <div class="row mt-5 shadow">
                        <div class="col-sm-4">
                            ...
                            <img class="img-fluid" src="/images/noImage.png" alt="ImageOfPost">
                            @else
                            <img class="img-fluid"
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="row col-sm-12">
                                <h4 class="pl-2" style="font-size:16px;"><a href="/profile/{{$post->user_id}}">Posted by
                                        : {{ $post->author->name ?? "N/A"}}</a>
                                </h4>
                            </div>
                            <div class="row col-sm-12">
                                <p>{{ $post->content}}</p>
                                ...
                                Without this, if an error occurs, the user cant see the error message
                                        Because the modal will be closed, when the update function will redirect back to the profile page-->
                                                ...
                                                <div class="modal-erer">
                                                    <h5 class="modal-title" id="exampleModalLongTitle">Edit Your Post
                                                    </h5>
