        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <form class="form-inline" action="{{ route('ssearch')}}" type="get" role="search">
                    <div class="col-sm-8"> <input style="width:100%;" class="form-control" type="search" placeholder="Ex: 'Laravel' " name="ssearch">
                    </div>
...
<div class="container">
    ...
    <div class="row m-2 s-user shadow mt-5" style="border-left:1px solid whitesmoke; border-bottom: 1px solid #0275d8;border-right:1px solid whitesmoke;border-top: 1px solid #0275d8;">
        <div class="col-sm-4 p-4">
            <img class="img-fluid" src="/storage/post_images/{{ $post->user_id }}/{{ $post->post_image }} "  alt="Image of Post">
        </div>
